...
- Update dependencies
- [#15](https://github.com/gurgeous/bust-a-gem/issues/15) Strip leading colons from queries (thanks @KamilMilewski)

#### 0.1.7 - Nov 2018

- [#5](https://github.com/gurgeous/bust-a-gem/issues/5) use specific SymbolKind for each symbol (thanks @feber)
...
This extension is [licensed under the MIT License](https://github.com/gurgeous/bust-a-gem/blob/master/LICENSE.txt).
